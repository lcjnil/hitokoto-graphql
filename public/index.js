...
new __WEBPACK_IMPORTED_MODULE_0__App_html__["a" /* default */]({ target: document.getElementById('container') });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Hitokoto_html__ = __webpack_require__(2);
	...
	return {
		onrender: function onrender() {
			...
			this.interval = setInterval(function () {
				_this.refs.hitokoto.getRandomHitokoto();
			}, 2000);
		},


		components: {
			Hitokoto: __WEBPACK_IMPORTED_MODULE_0__Hitokoto_html__["a" /* default */]
		}
	};
}();

function renderMainFragment(root, component) {
	var hitokoto = new template.components.Hitokoto({
		target: null,
		root: component.root || component
	});
	component.refs.hitokoto = hitokoto;

	return {
		mount: function mount(target, anchor) {
			hitokoto.mount(target, anchor);
		},

		update: function update(changed, root) {},

		teardown: function teardown(detach) {
			if (component.refs.hitokoto === hitokoto) component.refs.hitokoto = null;
			hitokoto.teardown(detach);
		}
	};
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__query__ = __webpack_require__(3);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var template = function () {
	return {
		...
		methods: {
			getRandomHitokoto: function getRandomHitokoto() {
				fetch('/graphql', {
					method: 'POST',
					headers: {
					...
					body: JSON.stringify({
						query: __WEBPACK_IMPORTED_MODULE_0__query__["a" /* randomHitokotoQuery */]
					})
				}).then(function (r) {
					return r.json();
				}).then(function (r) {
					return r.data.randomHitokoto;
				}).then(this.set);
			}
		}
	};
...
function renderMainFragment(root, component) {
	...
	div.setAttribute('svelte-3500181558', '');
	div.className = "root";
	...
	var text2 = document.createTextNode(root.author);
	...
	var text4 = document.createTextNode(root.source);
	...
	return {
		...
		update: function update(changed, root) {
			...
			text2.data = root.author;

			text4.data = root.source;
		},
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return randomHitokotoQuery; });
var randomHitokotoQuery = "\n  {\n    randomHitokoto {\n      id\n      content\n      source\n      author\n    }\n  }\n";
